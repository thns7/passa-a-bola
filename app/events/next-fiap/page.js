...
export default function NextFiapEvent() {
  ...
  const finalizarRodada = () => {
    ...
    // Salvar os pontos no ranking (mock por enquanto)
    const resultado = {
      userId: user?.id,
      nome: user?.name,
      pontos: pontos,
    ...
    console.log("Salvando no ranking:", resultado);
    // Aqui vai a integração com o backend/ESP32
        ...
        {!rodadaAtiva && !mostrarResultado ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center">
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-4">
              ...
              <div className="animate-pulse text-purple-600 font-bold">
